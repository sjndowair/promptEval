...
export default function ExamplesPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="mb-8 text-4xl font-bold text-purple-600 dark:text-blue-400">
        프롬프트 예시
      </h1>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="mb-4">
                    ...
                    <p className="rounded bg-gray-100 p-3 text-sm dark:bg-gray-700">
                      {example.prompt}
                    </p>
                  </div>
