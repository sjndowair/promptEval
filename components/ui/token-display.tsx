...
export function TokenDisplay() {
  ...
  const getTokenStatusColor = (remaining: number) => {
    if (remaining >= 7)
      return 'bg-purple-100 text-black-800 border-purple-200 dark:bg-blue-200 dark:text-blue-800 dark:border-blue-300';
    if (remaining >= 4)
      return 'bg-purple-100 border-purple-200 dark:bg-blue-100 dark:text-blue-800 dark:border-blue-200';
  ...
  return (
    <Card
      className={`border ${getTokenStatusColor(userTokens.totalTokens)} bg-purple-100 dark:bg-blue-200`}
    >
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Coins className="h-5 w-5 text-purple-600 dark:text-blue-600" />
            <div>
              <div className="flex items-center space-x-2">
