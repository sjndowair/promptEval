...
export function HeroSection() {
  ...
  const { user, userTokens, refreshUserTokens, setIsLoginModalOpen } =
    useStore();
    ...
    <section className={`${user ? `py-[4rem]` : 'py-[10rem]'} `}>
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          >
            <h1 className="bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-3xl font-bold tracking-tighter text-transparent dark:from-blue-400 dark:to-blue-600 sm:text-4xl md:text-5xl lg:text-6xl/none">
              프롬프트 평가 서비스
            </h1>
          </motion.div>
          <br />
          ...
          >
            <p>
              더 효과적인 프롬프트 작성을 위한 평가 서비스입니다. 프롬프트를
              입력하면 명확성, 구체성, 맥락 제공, 구조, 간결성 등의 기준으로
              평가하여 개선점을 제안해 드립니다.
            </p>
          </motion.div>
          <br />
