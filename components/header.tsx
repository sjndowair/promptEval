      ...
      >
          ...
          <div className="flex h-16 items-center justify-between">
            <Link href="/" className="flex items-center">
              <motion.div
                ...
                className="text-xl font-bold text-purple-600 dark:text-blue-400"
              >
                프롬프트 평가기
              </motion.div>
            </Link>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 rounded-full bg-purple-100 dark:bg-blue-900"
                      >
        ...
        {isOpen && (
          <motion.div
            ...
            className="border-t bg-white dark:border-gray-800 dark:bg-gray-900 md:hidden"
          >
